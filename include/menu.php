...
if (!isset($_SESSION["mikhmon"])) {
  ...
  if ($hotspot == "dashboard" || substr(end(explode("/", $url)), 0, 8) == "?session") {
    ...
    $supdate = "active";
    $mpage = "Update Aplikasi";
  } elseif ($agent == "manage" || $agent == "add" || $agent == "edit" || $agent == "topup") {
    $magent = "active";
    $mpage = "Agen";
    $agentmenu = "menu-open";
  } elseif ($agent == "prices") {
    ...
    $mpage = "Harga Agen";
    $agentmenu = "menu-open";
  } elseif ($agent == "transactions") {
    $magent = "active";
    $mpage = "Transaksi Agen";
    $agentmenu = "menu-open";
  } elseif ($agent == "fonnte") {
    $ssett = "active";
    $mpage = "Konfigurasi Fonnte";
    $settmenu = "menu-open";
  } elseif ($agent == "format-voucher") {
    $ssett = "active";
    $mpage = "Format Voucher";
    $settmenu = "menu-open";
  } elseif ($ppp == "ippool" || $ppp == "addpool") {
    $mppp = "active";
    $mpage = "IP Pool";
    $pppmenu = "menu-open";
  } elseif ($ppp == "billing") {
    $sbilling = "active";
    $mpage = "Manajemen Tagihan";
  }
...
<?php 
  ...
  <a href="./admin.php?id=update" class="menu <?= $supdate ?>"><i class="fa fa-cloud-download"></i> Update Aplikasi</a>
...
<div id="sidenav" class="sidenav">
  ...
  <!--ppp-->
  <div class="dropdown-btn <?= $mppp; ?>"><i class="fa fa-id-card"></i> PPP
    <i class="fa fa-caret-down"></i>
  </div>
  <div class="dropdown-container <?= $pppmenu; ?>">
    <a href="./?ppp=secrets&session=<?= $session; ?>" class="menu <?= $ssecrets; ?>"> <i class="fa fa-users"></i> PPP Secrets</a>
    <a href="./?ppp=profiles&session=<?= $session; ?>" class="menu <?= $spprofile; ?>"> <i class="fa fa-pie-chart"></i> PPP Profiles</a>
    <a href="./?ppp=active&session=<?= $session; ?>" class="menu <?= $spactive; ?>"> <i class="fa fa-wifi"></i> PPP Active</a>
    <a href="./?ppp=ippool&session=<?= $session; ?>" class="menu "> <i class="fa fa-database"></i> IP Pool</a>
  </div>
  <!--billing standalone-->
  <a href="./?ppp=billing&session=<?= $session; ?>" class="menu <?= $sbilling; ?>"><i class="fa fa-money"></i> Manajemen Tagihan</a>
  <!--quick print-->
  ...
  <a href="./?agent=format-voucher&session=<?= $session; ?>" class="menu "> <i class="fa fa-ticket "></i> Format Voucher </a>
  <a href="./?agent=fonnte&session=<?= $session; ?>" class="menu "> <i class="fa fa-whatsapp "></i> Konfigurasi Fonnte </a>          
  <a href="./admin.php?id=update" class="menu "> <i class="fa fa-cloud-download "></i> Update Aplikasi </a>          
  </div>
  <!--agent-->
  <div class="dropdown-btn <?= $magent; ?>"><i class="fa fa-users"></i> Agen
    <i class="fa fa-caret-down"></i>
  </div>
  <div class="dropdown-container <?= $agentmenu; ?>">
    <a href="./?agent=manage&session=<?= $session; ?>" class="menu "> <i class="fa fa-list"></i> Daftar Agen</a>
    <a href="./?agent=add&session=<?= $session; ?>" class="menu "> <i class="fa fa-user-plus"></i> Tambah Agen</a>
    <a href="./?agent=prices&session=<?= $session; ?>" class="menu "> <i class="fa fa-money"></i> Harga Agen</a>
    <a href="./?agent=transactions&session=<?= $session; ?>" class="menu "> <i class="fa fa-history"></i> Transaksi Agen</a>
  </div>
  <!--about-->
